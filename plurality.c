...
bool vote(string name)
{
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        ...
        {
            // if similar to what user vote for, then increase the specific candidate vote and
            // return true
            candidates[i].votes++;
            return true;
        }
...
void print_winner(void)
{
    ...
    for (int i = 0; i < candidate_count; i++)
    {
        // check for candidate votes that are  greater than maximum_vote and set them to
        // maximum_vote
